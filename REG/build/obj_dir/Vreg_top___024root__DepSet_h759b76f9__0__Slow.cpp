...
#endif
            VL_FATAL_MT("/home/robot/ysyx-workbench/nvboard/REG/vsrc/reg_top.v", 1, "", "Settle region did not converge.");
        }
...
VL_ATTR_COLD void Vreg_top___024root___ctor_var_reset(Vreg_top___024root* vlSelf) {
    ...
    vlSelf->reg_top__DOT__u_lfsr__DOT__count = 0;
    vlSelf->reg_top__DOT__u_lfsr__DOT__o_q_1 = 0;
    vlSelf->reg_top__DOT__u_lfsr__DOT____Vcellout__uo__o_q = 0;
    vlSelf->reg_top__DOT__u_lfsr__DOT____Vcellout__u1__o_q = 0;
    vlSelf->reg_top__DOT__u_lfsr__DOT____Vcellout__u2__o_q = 0;
    vlSelf->reg_top__DOT__u_lfsr__DOT____Vcellout__u3__o_q = 0;
    vlSelf->reg_top__DOT__u_lfsr__DOT____Vcellout__u4__o_q = 0;
    vlSelf->reg_top__DOT__u_lfsr__DOT____Vcellout__u5__o_q = 0;
    vlSelf->reg_top__DOT__u_lfsr__DOT____Vcellout__u6__o_q = 0;
    vlSelf->reg_top__DOT__u_lfsr__DOT____Vcellout__u7__o_q = 0;
    vlSelf->__Vdly__reg_top__DOT__u_lfsr__DOT__count = 0;
    vlSelf->__Vdly__o_led = 0;
    vlSelf->__Vdly__reg_top__DOT__u_lfsr__DOT____Vcellout__uo__o_q = 0;
