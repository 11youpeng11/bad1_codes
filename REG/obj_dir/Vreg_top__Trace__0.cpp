...
void Vreg_top___024root__trace_chg_0_sub_0(Vreg_top___024root* vlSelf, VerilatedVcd::Buffer* bufp);

void Vreg_top___024root__trace_chg_0(void* voidSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vreg_top___024root__trace_chg_0\n"); );
    // Init
    ...
    // Body
    Vreg_top___024root__trace_chg_0_sub_0((&vlSymsp->TOP), bufp);
}

void Vreg_top___024root__trace_chg_0_sub_0(Vreg_top___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    if (false && vlSelf) {}  // Prevent unused
    Vreg_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vreg_top___024root__trace_chg_0_sub_0\n"); );
    // Init
    uint32_t* const oldp VL_ATTR_UNUSED = bufp->oldp(vlSymsp->__Vm_baseCode + 1);
    // Body
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
        bufp->chgCData(oldp+0,((((IData)(vlSelf->reg_top__DOT__u_lfsr__DOT____Vcellout__u7__o_q) 
        ...
        bufp->chgBit(oldp+1,(vlSelf->reg_top__DOT__u_lfsr__DOT____Vcellout__uo__o_q));
        bufp->chgBit(oldp+2,(vlSelf->reg_top__DOT__u_lfsr__DOT____Vcellout__u1__o_q));
        bufp->chgBit(oldp+3,(vlSelf->reg_top__DOT__u_lfsr__DOT____Vcellout__u2__o_q));
        bufp->chgBit(oldp+4,(vlSelf->reg_top__DOT__u_lfsr__DOT____Vcellout__u3__o_q));
        bufp->chgBit(oldp+5,(vlSelf->reg_top__DOT__u_lfsr__DOT____Vcellout__u4__o_q));
        bufp->chgBit(oldp+6,(vlSelf->reg_top__DOT__u_lfsr__DOT____Vcellout__u5__o_q));
        bufp->chgBit(oldp+7,(vlSelf->reg_top__DOT__u_lfsr__DOT____Vcellout__u6__o_q));
        bufp->chgBit(oldp+8,(vlSelf->reg_top__DOT__u_lfsr__DOT____Vcellout__u7__o_q));
    }
    bufp->chgBit(oldp+9,(vlSelf->clk));
    bufp->chgBit(oldp+10,(vlSelf->rst));
    bufp->chgCData(oldp+11,(vlSelf->i_seg),8);
    ...
    bufp->chgCData(oldp+17,(vlSelf->reg_top__DOT__u_lfsr__DOT__count),4);
    bufp->chgBit(oldp+18,(((8U == (IData)(vlSelf->reg_top__DOT__u_lfsr__DOT__count))
                            ? ((IData)(vlSelf->reg_top__DOT__u_lfsr__DOT____Vcellout__u7__o_q) 
                               ^ ((IData)(vlSelf->reg_top__DOT__u_lfsr__DOT____Vcellout__u5__o_q) 
                                  ^ ((IData)(vlSelf->reg_top__DOT__u_lfsr__DOT____Vcellout__u3__o_q) 
                                     ^ (IData)(vlSelf->reg_top__DOT__u_lfsr__DOT____Vcellout__u4__o_q))))
                            : (IData)(vlSelf->reg_top__DOT__u_lfsr__DOT__o_q_1))));
    bufp->chgBit(oldp+19,(vlSelf->reg_top__DOT__u_lfsr__DOT__o_q_1));
