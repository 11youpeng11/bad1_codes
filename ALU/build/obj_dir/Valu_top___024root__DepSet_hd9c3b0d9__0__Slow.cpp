...
VL_ATTR_COLD void Valu_top___024root___eval_initial__TOP(Valu_top___024root* vlSelf) {
    ...
    vlSelf->alu_top__DOT__i3__DOT__i0__DOT__data_list[0U] = 0U;
    vlSelf->alu_top__DOT__i3__DOT__i0__DOT__data_list[1U] = 0U;
}
...
#endif  // VL_DEBUG
VL_ATTR_COLD bool Valu_top___024root___eval_phase__stl(Valu_top___024root* vlSelf);
...
#endif
            VL_FATAL_MT("/home/robot/ysyx-workbench/nvboard/ALU/vsrc/alu_top.v", 1, "", "Settle region did not converge.");
        }
        __VstlIterCount = ((IData)(1U) + __VstlIterCount);
        __VstlContinue = 0U;
        if (Valu_top___024root___eval_phase__stl(vlSelf)) {
            __VstlContinue = 1U;
        }
...
VL_ATTR_COLD void Valu_top___024root___stl_sequent__TOP__0(Valu_top___024root* vlSelf) {
    ...
    alu_top__DOT__i0__DOT__i0__DOT__lut_out = ((IData)(alu_top__DOT__i0__DOT__i0__DOT__lut_out) 
                                               | ((- (IData)(
                                                  ...
                                                  & vlSelf->alu_top__DOT__i0__DOT__i0__DOT__data_list
                                                  [7U]));
    vlSelf->alu_top__DOT__o_led_0 = alu_top__DOT__i0__DOT__i0__DOT__lut_out;
...
VL_ATTR_COLD bool Valu_top___024root___eval_phase__stl(Valu_top___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Valu_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Valu_top___024root___eval_phase__stl\n"); );
    // Init
...
VL_ATTR_COLD void Valu_top___024root___ctor_var_reset(Valu_top___024root* vlSelf) {
    ...
    vlSelf->o_max = 0;
    vlSelf->o_equ = 0;
    vlSelf->alu_top__DOT__o_led_0 = 0;
